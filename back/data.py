...
elements = [
  {
  'trees': [
      {'id': 0, 'cords': [6262893.996637655, 7970140.548852169], 'name':'Лиственица', 'photos': ['https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Sequoiadendron_giganteum_at_Kenilworth_Castle.jpg/450px-Sequoiadendron_giganteum_at_Kenilworth_Castle.jpg'], 'height': 100, 'trunkDiameter': 10, 'age': 1, 'damage': [], 'crownProjection': 1234, 'assessment': 4, 'comment': "Какой-то комментарий", 'recommendation': [], 'trunkNumber': 10, 'sanitaryCondition': 3, 'lastChange': datetime.now().isoformat()},
      {'id': 1, 'cords': [6262767.635141125, 7970040.966693438], 'name':'Пихта',  'photos': ['https://gas-kvas.com/grafic/uploads/posts/2023-09/1695808091_gas-kvas-com-p-kartinki-derevo-16.jpg'], 'height': 100, 'trunkDiameter': 10, 'age': 1, 'damage': [0,5], 'crownProjection': 2,  'assessment': 0, 'comment': "Какой-то комментарий",'recommendation': [0,1], 'trunkNumber': 10, 'sanitaryCondition': 1},
      {'id': 2, 'cords': [6262825.3227447625, 7970092.685098305], 'name':'Дуб',  'photos': ['https://get.pxhere.com/photo/landscape-tree-nature-branch-plant-meadow-rural-green-botany-head-deciduous-oak-grove-ecosystem-individually-flowering-plant-biome-sommer-head-woody-plant-land-plant-plane-tree-family-708077.jpg'], 'height': 100, 'trunkDiameter': 10, 'age': 2, 'damage': [0,5], 'crownProjection': 1234, 'assessment': 0, 'comment': "Какой-то комментарий",'recommendation': [0,1], 'trunkNumber': 10,'sanitaryCondition': 2},
  ],
  'furnitures': [
      {'id': 0, 'cords': [6262937.633878046, 7970171.230471022], 'name':'Будка 1', 'comment': "", 'assessment': 0, 'lastChange': datetime.now().isoformat()},
